...
console.log( "I'll be a hardcore programmer!!! Thanks Niilante! From all" );
...
console.log('%cFork it on GitHub: https://github.com/devinvogue/git-mantse.git', 'background: #0057A0; color: white; display: block; padding: 3px;');
